...
# You can use this to define app-wide variables if needed
# No required root-level variables needed unless you abstract env names

# Example only if needed for dynamic naming
variable "app_name" {
